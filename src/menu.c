	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "ABNORMAL HILL ZONE", {"TOO SLOW", "YOU CAN RUN", "TRIPLE TROUBLE"}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_1_1, 0xFF9271FD, "TOO SLOW"},
				{StageId_1_2, 0xFF9271FD, "YOU CANT RUN"},
				{StageId_1_3, 0xFF9271FD, "TRIPLE TROUBLE"},
				{StageId_1_4, 0xFF9271FD, "ENDLESS"},
				{StageId_2_1, 0xFF223344, "CYCLES"},
				{StageId_2_2, 0xFF223344, "MILK"},
				{StageId_2_3, 0xFF223344, "TOO FEST"},
				{StageId_3_1, 0xFF941653, "SUNSHINE"},
				{StageId_3_2, 0xFF941653, "CHAOS"},
				{StageId_3_3, 0xFF941653, "ROUND A BOUT"},
				{StageId_4_1, 0xFFFC96D7, "FATALITY"},
				{StageId_4_2, 0xFFFC96D7, "PERSONEL"},
			};
