...
#define STAGE_LOAD_PLAYER5    (1 << 4)  //Reload player5 character
#define STAGE_LOAD_OPPONENT   (1 << 5)  //Reload opponent character
#define STAGE_LOAD_OPPONENT2  (1 << 6)  //Reload 2nd opponent character
#define STAGE_LOAD_OPPONENT3  (1 << 7)  //Reload 3rd opponent character
#define STAGE_LOAD_OPPONENT4  (1 << 8)  //Reload 4th opponent character
#define STAGE_LOAD_OPPONENT5  (1 << 9)  //Reload 5th opponent character
#define STAGE_LOAD_GIRLFRIEND (1 << 10) //Reload girlfriend character
#define STAGE_LOAD_STAGE      (1 << 11) //Reload stage
#define STAGE_LOAD_FLAG       (1 << 12)
...
#define StageId_LastVanilla StageId_4_2
...
typedef struct
{
	...
	struct
	{
		Character* (*new)();
		fixed_t x, y;
	} pchar, pchar2, pchar3, pchar4, pchar5, ochar, ochar2, ochar3, ochar4, ochar5, gchar;
